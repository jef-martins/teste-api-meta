...
exports.convertVariablesBtoF = exports.convertVariablesFtoB = exports.toEstadoName = exports.stateMachineToFlow = exports.flowToStateMachine = void 0;
...
function stateMachineToFlowOg(estados, transicoes, variaveis = []) {
    ...
    const nodes = estados.map((e, idx) => {
        ...
        const properties = handlerConfigToProperties(nodeType, e.handler, e.config, e.estado);
        return {
            id: nodeId,
            type: nodeType,
            position,
...
exports.flowToStateMachine = flowToStateMachineOg;
exports.stateMachineToFlow = stateMachineToFlowOg;
exports.toEstadoName = toEstadoNameOg;
exports.convertVariablesFtoB = convertVariablesFtoBOg;
exports.convertVariablesBtoF = convertVariablesBtoFOg;
//# sourceMappingURL=flowConverter.js.map