...
let FlowConverterService = class FlowConverterService {
    ...
    convertVariablesDeep(obj, converter) {
        ...
        if (typeof obj === 'object' && obj !== null) {
            return Object.fromEntries(Object.entries(obj).map(([k, v]) => [k, this.convertVariablesDeep(v, converter)]));
        }
        return obj;
    }
    ...
    actionNodeToHandler(props, subs) {
        ...
        if (setVar) {
            ...
            return {
                handler: '_handlerCapturar',
                config: { campos: assignments.map((a) => ({ nome: a.key, mensagemPedir: '' })), transicaoAutomatica: true },
            };
        }
        if (props.endpoint) {
            return {
